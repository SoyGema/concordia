...
def run_full_gemma_3_baseline():
    ...
    try:
        ...
        try:
            ...
            fitness_stats = measurements.get_channel('evolutionary_fitness_statistics')  # Fix: get scores from correct channel
            ...
            for gen_data in gen_summaries:
                generation_num = len(results_data['generations']) + 1
